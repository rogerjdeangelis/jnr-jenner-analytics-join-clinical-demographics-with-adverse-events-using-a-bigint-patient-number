# jnr-jenner-analytics-join-clinical-demographics-with-adverse-events-using-a-bigint-patient-number
Jenner analytics join STDM clinical demographics with adverse events using a bigint patient number
    ...
    /******************************************************************************************************************/
     ...
     /******************************************************************************************************************/
    filename ft15f001 "c:/otojnr/jnr_submit_duck.sas";
    parmcards4;
    %macro jnr_submit_duck(
           pgm
